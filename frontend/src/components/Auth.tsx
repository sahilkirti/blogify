...
import { SignupInput } from '@sahilkirti/medium-blog';
...
export const Auth = ({ type }: {type: "signup" | "signin"}) => {
    ...
    async function sendRequest() {
        try {
            const response:AxiosResponse<any> = await axios.post(`${BACKEND_URL}/api/v1/user/${type === "signup" ? "signup" : "signin"}`,postInputs);
    ...
    return (
       <div className="h-full flex flex-col justify-center">
            ...
            <div className="flex justify-center">
                <div>
                    <div className='px-10'>
                        <div className="center text-3xl font-bold">
                            Create an account
                        </div>
